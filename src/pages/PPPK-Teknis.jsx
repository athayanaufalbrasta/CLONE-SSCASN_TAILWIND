	...
	return (
		<div className="w-screen h-screen scroll-smooth">
			<div className="container mx-auto p-10 md:px-20 grid gap-10">
				<h1 className="text-center font-bold text-3xl text-[#40588A]">Frequently Asked Questions (PPPK Teknis)</h1>
						...
						<div className="w-full flex flex-col border-2 rounded-lg">
							{link.map((e, i) => (
								<span
									...
									className={`text-blue-700 hover:text-blue-800 hover:font-semibold px-4 py-2 ${e.title !== "E-Materai" && "border-b-2"}`}
								>
									{e.title}
								</span>
							))}
