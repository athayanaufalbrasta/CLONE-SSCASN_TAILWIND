...
export default function Alur() {
  return (
    <section className="slideDown dark:bg-[#353941]">
      <div className="container mx-auto grid grid-cols-1 gap-5 py-12 text-center">
        <h1 className="text-4xl font-bold text-blue-800 dark:text-gray-200">Alur Seleksi SSCASN</h1>
